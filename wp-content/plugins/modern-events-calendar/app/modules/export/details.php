     ...
     <div class="mec-event-exporting">
        <div class="mec-export-details">
            <ul>
                ...
                <?php if($settings['sn']['ical']): ?><li><a class="mec-events-gcal mec-events-button mec-color mec-bg-color-hover mec-border-color" href="<?php echo $this->ical_URL($event->data->ID); ?>"><?php echo __('+ iCal / Outlook export', 'mec'); ?></a></li><?php endif; ?>
            </ul>
        </div>
    </div>
</div>