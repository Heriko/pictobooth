...
>
	<div class="jet-engine-edit-page__fields">
		...
		<jet-meta-fields v-model="metaFields" :hide-options="[ 'object_type', 'allow_custom', 'save_custom' ]" slug-delimiter="_"></jet-meta-fields>
		<cx-vui-collapse
			:collapsed="false"
		>
			<h3 class="cx-vui-subtitle" slot="title"><?php _e( 'Admin Columns', 'jet-engine' ); ?></h3>
			<div slot="content">
				<div class="cx-vui-repeater-item cx-vui-panel" v-for="field in fieldsForColumns" v-if="field.name && 'html' !== field.type">
