<div id="gateways_data">
	...
	<div class="jet-engine-gateways-group" v-if="notificationsList && notificationsList.length">
		...
		<div class="jet-engine-gateways-group__item">
			...
			?></div>
			<div v-for="( notification, index ) in notificationsList" v-if="'insert_post' !== notification.type && 'redirect' !== notification.type" :key="'before_' + index">
				<label>
		...
		<div class="jet-engine-gateways-group__item">
			...
			?></div>
			<div v-for="( notification, index ) in notificationsList" v-if="'insert_post' !== notification.type && 'redirect' !== notification.type" :key="'before_' + index" :key="'success_' + index">
				<label>
					<input type="checkbox" name="_gateways[notifications_success][]" :value="index" :disabled="'insert_post' === notification.type" v-model="gateways.notifications_success">
					{{ getNotificationLabel( notification ) }}
				</label>
			</div>
		</div>
		<div class="jet-engine-gateways-group__item">
			...
			?></div>
			<div v-for="( notification, index ) in notificationsList" v-if="'insert_post' !== notification.type && 'redirect' !== notification.type" :key="'before_' + index" :key="'failed_' + index">
				<label>
					<input type="checkbox" name="_gateways[notifications_failed][]" :value="index" :disabled="'insert_post' === notification.type" v-model="gateways.notifications_failed">
					{{ getNotificationLabel( notification ) }}
				</label>
			</div>
		</div>
